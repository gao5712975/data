~function (r, K, z, L) {
    var b = r.document, p = function () {
        ...
        return a[a.length - 1]
    }(), t = p.getAttribute("sid") || 0, q = "" + (new Date).getTime() + Math.floor(1E3 * Math.random()), w = b.location, A = function (a) {
        try {
            a = top.document.URL
        } catch (b) {
        }
    ...
    var J = (navigator.userAgent.match(/MSIE([^;]+)/i) || [])[1] || 100, F = function (a) {
        var b = /^\s+|\s+$|\r\n|\r|\n/g;
        try {
        ...
        var l = {}, f = {}, k = Math.round(c.time / 30), m = 0, d;
                ...
                for (var d in b) {
                    switch (c.type) {
                        ...
                        case "ease-out":
                            ...
                            break;
                        case "ease":
                            .5 >= m / k ? (e = m / k * 1.5, e = l[d] + f[d] * e * e * e) : E(a, b, {time: c.time / 2, fn: c.fn})
                    }
    ...
    z.init = function () {
        var a =
            this;
        L && a.croDomain(K, {d: "xinhuanetv2", url: A, ref: M, sid: t, r: q, bt: window._ycads_bt || ""}, function (b) {
            b = b || {};
            0 == b.code && a.render(b)
        })
    };
    z.croDomain = function (a, n, c) {
        var l, f, k = r.postMessage, m = "YCADS_IFR_" + q, d = b.createElement("form"), p = b.createDocumentFragment(), e = function () {
            ...
            try {
                f = F((a || r.event).data || ""), f.r == q && (e.setAttribute("_state", 2),
                    c(f), D(d))
            } catch (g) {
            }
        }, g = function () {
            ...
            } else 0 == e.getAttribute("_state") && setTimeout(function () {
                try {
        ...
        ~function () {
            ...
            if (n && "object" == typeof n)for (var c in n)if (n.hasOwnProperty(c)) {
                try {
                    l = b.createElement('<input type="hidden" name=\'' +
                        c + "'>")
                } catch (f) {
    ...
    z.render = function (a, n) {
        var c = String(a.ct), l = a.n, f = a.w, k = a.h, m = a.u, d = a.c, w = a.e, e = function (a, c) {
            var f = r.innerHeight || b.documentElement.clientHeight || b.body.clientHeight,
                d = r.innerWidth || b.documentElement.clientWidth || b.body.clientWidth, e = b.documentElement.scrollTop || b.body.scrollTop, h = b.documentElement.scrollLeft || b.body.scrollLeft;
            1 == c ? (E(a, {top: e + f / 2}), a.style.left = h + "px") : 2 == c ? (E(a, {top: e + f / 2}), a.style.left = h + d - a.offsetWidth + "px") : 3 == c && (a.style.top = e + f - a.offsetHeight + "px", a.style.left = h + d - a.offsetWidth + "px")
        }, x = function (a, b, f, d, e) {
            var h = "", k = '<img height="<%height%>" width="<%width%>" border="0" src="<%src%>" style="width:<%width%>px;height:<%height%>px;line-height:<%height%>px;display:block;" />';
            ...
            switch (String(f)) {
                ...
                case "1":
                    ...
                    a = u('<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" align="middle" width="<%width%>" height="<%height%>"><param name="allowScriptAccess" value="always" /><param name="movie" value="<%src%>"/><param name="quality" value="high"/><param name="bgcolor" value="#000"/><param name="height" value="<%height%>" /><param name="width" value="<%width%>" /><param name="FlashVars" value="<%bar%>" /><param name="allowFullScreen" value="<%full%>" /><param name="wmode" value="<%wmode%>" /><embed src="<%src%>" quality="high" bgcolor="#000" width="<%width%>" height="<%height%>" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" allowscriptaccess="always" loop="true" allowfullscreen="<%full%>" flashvars="<%bar%>" wmode="<%wmode%>"></embed></object>',
                        {src: a, width: d, height: e, bar: !1, wmode: "transparent", full: !1});
                    h = f + (h + a);
                    break;
                case "2":
                    h += b + "";
                ...
                case "4":
                    d = h, e = "<style>#YCADS" + t + "_" + q + " img{-moz-transition:-moz-transform .3s ease;-ms-transition:-ms-transform .3s ease;transition:transform .3s ease;}#YCADS" + t + "_" + q + " img:hover{-webkit-transform:scale(1.1); -moz-transform:scale(1.1); -ms-transform:scale(1.1); transform:scale(1.1)}</style>", e = [17 == c ? e : "", "<%for(var i=0;i<e.length;i++){%>", 17 == c ? '<a href="<%e[i].link%>" title="<%e[i].text%>" target="<%target%>" style="display:block;line-height:30px;font-size:22px;color:#000;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;text-decoration:none;font-family:\'\u5fae\u8f6f\u96c5\u9ed1\';"><%e[i].text%></a>' :
                        ...
                        "<div><%e[i].desc%>", 17 == c ? "" : ' [<a style="color:#666;text-decoration: none;" href="<%e[i].link%>" target="_blank">\u8be6\u60c5</a>]', "</div></div></div><%}%>"].join(""), text = u(e, {
                        e: a,
                        width: 138,
                        height: 90,
                        target: "_blank"
        ...
        (0 < m.length || 0 < w.length) && ~function () {
            var g, n, z = ['<html><head><style>*{margin:0;padding:0;border:0}body,html{background-color:transparent;overflow:hidden;width:100%;height:100%}a{cursor:pointer;text-decoration:none;outline:none;hide-focus:expression(this.hideFocus=true);box-sizing:border-box;-moz-box-sizing:border-box;-ms-box-sizing:border-box;-o-box-sizing:border-box;-webkit-box-sizing:border-box;overflow:hidden}</style></head><body oncontextmenu="return false">',
                "</body></html>"], A = '<script type="text/javascript">self._ycads_bt=1;\x3c/script><script sid="' + t + '" type="text/javascript" src="' + p.src + '" >\x3c/script>', F = "titlebar=no,location=no,directories=no,status=no,menubar=no,scrollbar=no,resizable=no,copyhistory=yes,left=" + (r.screen.width / 2 - f[0] / 2) + ",top=" + (r.screen.height / 2 - k[0] / 2) + ",width=" + f[0] + ",height=" + k[0], h = 'position:relative;z-index:100;width:<%width=="auto"?"100%":width+"px"%>;height:<%height=="auto"?"auto":height+"px"%>;overflow:hidden;display:block;background-color:#F2F8FA;margin:0 auto;';
            if (3 == c)g = b.createElement("div"), h += "position:fixed;_position:absolute;z-index:2147483647;bottom:0;right:0;", g.insertAdjacentHTML("beforeend", x(m[0], d[0], l, f[0], k[0]) + '<div onclick="document.body.removeChild(this.parentNode)" style="position:absolute;top:0;right:0;height:18px;line-height:18px;width:18px;text-align:center;font-size:18px;font-family:simsun;background-color:#ccc;opacity:0.8;cursor: pointer;"> &times; </div>'), g.style.cssText = u(h, {
                height: k[0],
                width: f[0]
            }), g.id = "YCADS" + t + "_" + q, v.insertBefore(g,
                v.firstChild), 8 > J && function () {
                e(g, 3);
                ...
                g.style.cssText = u(h, {height: k[0], width: f[0]});
                ...
                0 == a["default"] && 0 == a.urgent && (y.insertAdjacentHTML("beforeend", x(m[1], d[1], l, f[1], k[1])), y.style.cssText = u(h + "position:absolute;z-index:2147483647;top:0;left:50%;margin-left:<%-width/2%>px;", {
                    height: 0,
                    width: f[1]
                }), y.id = "YCADS" + t + "_top_" + q, v.insertBefore(y, v.firstChild), E(y, {height: k[1]}, {
                    fn: function () {
                        setTimeout(function () {
                            E(y, {height: 0}, {
                                fn: function () {
            ...
            } else if (10 == c || 19 == c)h += "background-color:transparent;", g = b.createElement("div"), g.insertAdjacentHTML("beforeend",
                x(w, "", 3)), 19 == c && (h += "display:inline-block;"), g.style.cssText = u(h, {
                height: k[0],
                width: f[0]
            }), g.id = "YCADS" + t + "_" + q, p.parentNode && p.parentNode.insertBefore(g, p); else if (17 == c || 20 == c)h += "background-color:transparent;", g = b.createElement("div"), g.insertAdjacentHTML("beforeend", x(w, "", 4)), g.style.cssText = u(h, {
                height: "auto",
                width: "auto"
            }), g.id = "YCADS" + t + "_" + q, p.parentNode && p.parentNode.insertBefore(g, p); else if (11 == c) {
                var B = b.createElement("div"), C = b.createElement("div"), h = h + "position:fixed;_position:absolute;z-index:2147483647;top:50%;margin-top:<%-height/2%>px;<%style%>";
                ...
                B.style.cssText = u(h, {height: k[0], width: f[0], style: "left:0;"});
                ...
                C.style.cssText = u(h, {height: k[1], width: f[1], style: "right:0;"});
                B.id = "YCADS" + t + "_l_" + q;
                ...
                var G = 1, H = 1, I, D = function () {
                    var a = (b.documentElement.clientHeight || b.body.clientHeight) - g.offsetHeight, c = g.offsetLeft + G, d = g.offsetTop + H;
            ...
            } else g = b.createElement("div"), g.insertAdjacentHTML("beforeend", x(m[0], d[0], l, f[0], k[0])), g.style.cssText = u(h, {height: k[0], width: f[0]}), g.id = "YCADS" + t + "_" + q, p.parentNode && p.parentNode.insertBefore(g, p)
        }()
    };
    z.init()
}(window, "http://m3.xinhuanet.com/s?", {v: "20160908.001"}, 1);